...
utility1=zeros(1,number);
utility2=zeros(1,number);
utility3=zeros(1,number);
utility4=zeros(1,number);
utility5=zeros(1,number);
...
for Backoff_St=1:5
    ...
    % Strategy 1 %
        ...
        utility1(N) = good_time / total_time;
        end
    ...
    % Strategy 2 %
        ...
        utility2(N) = good_time / total_time;
    end
    ...
    if Backoff_St == 3
        ...
        utility3(N) = good_time / total_time;
    end
    ...
    % Strategy 4 %
        ...
        while total_time < T
            ...
            utility4(N) = good_time / total_time;
        end
    end
        ...
        % strategy 5 %
            ...
            utility5(N) = good_time / total_time;
        end
    end
